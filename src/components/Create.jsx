...
const Create = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 w-full md:w-[60%] lg:w-[60%] rounded-2xl p-6 md:p-8 lg:p-10 md:mr-[10%] shadow-lg">
      <div className="bg-white rounded-xl p-6 md:p-8 shadow-md">
        <h1 className="mb-8">
          <span className="text-4xl md:text-6xl lg:text-8xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent tracking-wide">
            TO DO
          </span>
          <br />
          <span className="block mt-2 text-lg md:text-xl lg:text-2xl font-light text-gray-600 tracking-[.24em]">
            Reminds Everything
          </span>
        </h1>
